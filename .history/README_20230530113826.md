...
[![Product Name Screen Shot][product-screenshot]](images/logo-footer.svg)

Here's a blank template to get started: To avoid retyping too much info. Do a search and replace with your text editor for the following: `runeunhjem`, `portfolio1-ca`, `runeunhjem`, `runeunhjem`, `gmail`, `runeunhjem`, `Portfolio 1 - Course Assignment`, `As a developer, you will have to maintain a level of professionalism. This extends past writing code. We need to document our apps so that other developers can run the code without any issues. We also need to keep a professional-looking portfolio so that others have confidence in us and the work that we do.`
