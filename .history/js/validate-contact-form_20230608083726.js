function validateContactForm() {
  ...
  function validateForm(event) {
    ...
    if (checkLength(contactName.value, 4)) {
      ...
      nameAfter.classList.remove("show-checkmark"); // Add this line
    ...
    if (
      ...
      nameAfter.style.display = "block";
      emailAfter.style.display = "block";
      subjectAfter.style.display = "block";
      messageAfter.style.display = "block";
    } else {
      sendMessageButton.innerText = "Send Message";
      confirmSuccess.style.display = "none";
      nameAfter.style.display = "none";
      emailAfter.style.display = "none";
      subjectAfter.style.display = "none";
