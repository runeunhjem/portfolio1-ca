...
function loadCurrentImage(container) {
  ...
  const projectClass = container.closest(".carousel-item").querySelector(".project-container").classList.item(1);
...
function handleArrowClick(event) {
  ...
  const projectClass = carouselContainer.closest(".carousel-item").querySelector(".project-container").classList.item(1);
