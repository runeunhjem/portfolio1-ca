function validateContactForm() {
  ...
  const emailAfter = document.getElementById("name-after");
  const subjectAfter = document.getElementById("name-after");
  const messageAfter = document.getElementById("name-after");
  ...
  function validateForm(event) {
    ...
    if (checkLength(contactName.value, 4)) {
      ...
      // contactName.style.backgroundColor = "#a3ffaa";
