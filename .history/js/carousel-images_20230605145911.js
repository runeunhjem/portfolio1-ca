...
function updateProjectCounter(currentPosition, maxPosition) {
...
function handleArrowClick(event) {
  ...
  const carouselContainer = arrow.closest(".project-image-carousel").querySelector(".carousel-images");
  ...
  updateProjectCounter(newPosition, maxPosition);
}
