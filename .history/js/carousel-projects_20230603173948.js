...
console.log("Right after return container - imageUrls:", imageUrls);
...
function loadCurrentImage(imageUrls) {
  try {
    console.log("Inside loadCurrentImage - imageUrls:", imageUrls);
...
//   try {
//     console.log("Inside loadCurrentImage - imageUrls:", projectContainers[currentProjectIndex].imageUrls);
...
function initializeCarousel() {
  ...
  console.log("Initial imageUrls:", projectContainers[currentProjectIndex].imageUrls);
