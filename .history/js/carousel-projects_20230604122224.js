...
function createProjectContainer(projectId, title, tagline, description, imageUrls, links) {
  ...
  container.className = "project-container flex-column card-container";
...
console.log(`projectContainers is: ${projectContainers.project1Container.label}`);
// function loadCurrentImage(imageUrls) {
//   console.log(`projectContainers is: ${projectContainers}`);
