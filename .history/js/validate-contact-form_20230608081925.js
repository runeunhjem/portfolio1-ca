function validateContactForm() {
  ...
  const nameAfter = document.getElementById("name-after::after");
  const emailAfter = document.getElementById("email-after::after");
  const subjectAfter = document.getElementById("subject-after::after");
  const messageAfter = document.getElementById("message-after::after");
  ...
  function validateForm(event) {
    ...
    if (checkLength(contactName.value, 4)) {
      ...
      nameAfter.style.content = "url(../images/ico-checkmark-green.svg)";
