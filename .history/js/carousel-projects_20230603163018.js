...
const project2Container = createProjectContainer(
  ...
  ["csm/cms-1.jpg", "csm/cms-2.jpg", "csm/cms-3.jpg", "csm/cms-4.jpg", "csm/cms-5.jpg", "csm/cms-6.jpg", "csm/cms-7.jpg", "csm/cms-8.jpg", "csm/cms-9.jpg"],
  [
...
const project3Container = createProjectContainer(
  ...
  ["chefs-table/ct-1.jpg", "chefs-table/ct-2.jpg", "chefs-table/ct-3.jpg", "chefs-table/ct-4.jpg", "chefs-table/ct-5.jpg", "chefs-table/ct-6.jpg", "chefs-table/ct-7.jpg", "chefs-table/ct-8.jpg"],
  [
...
carousel-projects.js:177 Uncaught TypeError: Cannot read properties of undefined (reading '0')
    at loadCurrentImage (carousel-projects.js:177:42)
    at carousel-projects.js:203:1
...
leftArrow.addEventListener("click", () => {
  ...
  if (currentPosition < 0) {
    currentPosition = projectContainers[currentProjectIndex].imageUrls.length - 1;
  }
...
rightArrow.addEventListener("click", () => {
  currentPosition++;
  if (currentPosition >= projectContainers[currentProjectIndex].imageUrls.length) {
    currentPosition = 0;
  }
