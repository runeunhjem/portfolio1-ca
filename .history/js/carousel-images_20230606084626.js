...
function loadCurrentImage(container) {
  ...
  container.style.transition = "background-image 0.3s ease-in-out, transform translateX(100) 0.3s ease-in-out";
  container.style.backgroundImage = `url(${imagePath})`;
  container.style.transform = "translateX(100)"; // Reset the translation
}
