...
function loadCurrentImage(container) {
  const projectClass = container.parentNode.parentNode.parentNode.classList[1];
...
function handleArrowClick(event) {
  ...
  const projectClass = carouselContainer.parentNode.parentNode.parentNode.classList[1];
