...
const project2Container = createProjectContainer(
  ...
  "Semester Project 1. The site should appeal to youngsters, and take for granted that the audience is curious and intelligent. No libraries or frameworks were used.",
