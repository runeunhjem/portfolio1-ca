document.addEventListener("DOMContentLoaded", function () {
  ...
  //   const projectsContainerTop = 300 + scrollTop;
  ...
  //     clonedNav.style.backgroundColor = "rgb(250, 238, 227, 5)";
  //     // clonedNav.style.width = "90%";
  //     // clonedNav.style.height = "90px";
  //     clonedNav.style.marginTop = "0";
