...
function loadCurrentImage(container) {
  ...
  updateImageCounter(position, imageUrls[projectClass].length - 1);
}
...
function handleArrowClick(event) {
  ...
  projectClass = carouselContainer.closest(".carousel-item").querySelector(".project-container").classList.item(2);
